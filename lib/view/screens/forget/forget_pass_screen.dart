...
class _ForgetPassScreenState extends State<ForgetPassScreen> {
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            ...
            Padding(
              ...
              child: Text('please_enter_email_or_username'.tr, style: poppinsRegular, textAlign: TextAlign.center),
            ),
            ...
            GetBuilder<AuthController>(builder: (authController) {
              return !authController.isLoading ? CustomButton(
                radius: Dimensions.RADIUS_EXTRA_LARGE, buttonText: 'next'.tr,
  ...
  void _forgetPass(String userName) async {
    if (userName.isEmpty) {
      ...
      Response response = await  Get.find<AuthController>().forgetPassword(userName);
