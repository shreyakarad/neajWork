...
class RouteHelper {
  ...
  static String getSplashRoute(
      PendingDynamicLinkData pendingDynamicLinkData, String notyType) {
    String _pendingDynamicLinkData = ' ';
    if (pendingDynamicLinkData != null) {
      _pendingDynamicLinkData = pendingDynamicLinkData.link.toString();
    }
  ...
  static String getCheckoutRoute(
      String page, CouponModel coupon, ShippingMethodModel shipping,
      {bool reOrder}) {
    String _coupon;
    if (coupon != null) {
  ...
  static String getShopRoute(ShopModel shopData) {
    String _shop;
    if (shop != null) {
      _shop = base64Encode(utf8.encode(jsonEncode(shopData.toJson())));
    }
    return '$shop?shop=$_shop';
  }

  static String getSearchRoute() => '$search';
  static String getSearchShopProductRoute(int shopID) =>
      '$searchShopItem?id=$shopID'; //
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () {
          ...
          return SplashScreen(
            pendingDynamicLink: Get.parameters['splash'] != ' '
                ? Get.parameters['splash']
                : null,
            notyType:
                Get.parameters['type'] != ' ' ? Get.parameters['type'] : null,
          );
        }),
    ...
    GetPage(
        name: popularProduct,
        page: () => AllProductScreen(productType: ProductType.POPULAR_PRODUCT)),
    GetPage(
        name: reviewedProduct,
        page: () =>
            AllProductScreen(productType: ProductType.REVIEWED_PRODUCT)),
    GetPage(
        name: onSaleProduct,
        page: () => AllProductScreen(productType: ProductType.SALE_PRODUCT)),
    GetPage(
        name: cart,
        page: () {
          //cartModel
    ...
    GetPage(
        ...
        page: () => ImageViewerScreen(
              product: ProductModel.fromJson(jsonDecode(utf8.decode(base64Url
    ...
    GetPage(
        name: privacyPolicy,
        page: () => HtmlViewerScreen(htmlType: HtmlType.PRIVACY_POLICY)),
    GetPage(
        name: aboutUs,
        page: () => HtmlViewerScreen(htmlType: HtmlType.ABOUT_US)),
    GetPage(
        name: termsAndConditions,
        page: () => HtmlViewerScreen(htmlType: HtmlType.TERMS_AND_CONDITION)),
    GetPage(
        name: coupon,
        page: () =>
            CouponScreen(formCart: Get.parameters['formCart'] == 'true')),
    GetPage(
        name: update,
    ...
    GetPage(
        ...
        page: () {
          ...
          if (Get.parameters['coupon'] != 'null') {
            _coupon = CouponModel.fromJson(jsonDecode(utf8.decode(
                base64Decode(Get.parameters['coupon'].replaceAll(' ', '+')))));
          }
          ...
          if (Get.parameters['shipping'] != 'null') {
            _shipping = ShippingMethodModel.fromJson(
              jsonDecode(utf8.decode(base64Decode(
                  Get.parameters['shipping'].replaceAll(' ', '+')))),
              fromRoute: true,
            );
          }
    ...
    GetPage(
        name: shop,
        page: () => ShopScreen(
            shop: ShopModel.fromJson(jsonDecode(
                utf8.decode(base64Url.decode(Get.parameters['shop'])))))),

    GetPage(name: search, page: () => SearchScreen()),
    GetPage(
        name: searchShopItem,
        page: () => ShopProductSearchScreen(storeID: Get.parameters['id'])),
    GetPage(
        name: language,
        page: () =>
    ...
    GetPage(
        name: groupedProductScreen,
        page: () {
          List<int> _decode =
              base64Decode(Get.parameters['data'].replaceAll(' ', '+'));
          GroupedProduct _data =
              GroupedProduct.fromJson(jsonDecode(utf8.decode(_decode)));
