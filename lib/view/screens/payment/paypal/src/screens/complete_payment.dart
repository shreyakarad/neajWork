...
import 'package:flutter_woocommerce/view/screens/payment/paypal/src/errors/network_error.dart';
      ...
      body: Container(
        child: loading
            ? Column(
                children: const [
                  Expanded(
                    child: Center(child: Padding(padding: EdgeInsets.all(10), child: CircularProgressIndicator())),
                  ),
                ],
              )
            : loadingError
