...
class CustomButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Center(child: SizedBox(width: width != null ? width : Dimensions.WEB_MAX_WIDTH, height: height != null ? height : 50, child: Container(
      decoration: BoxDecoration(
        gradient: LinearGradient( colors: transparent ? [ Theme.of(context).cardColor, Theme.of(context).cardColor ] : [ Get.isDarkMode ? Theme.of(context).primaryColorDark : Theme.of(context).primaryColor, Theme.of(context).colorScheme.secondaryContainer]),
        borderRadius: BorderRadius.circular(radius),
        border: Border.all(color: transparent ? Theme.of(context).hintColor : Colors.transparent)
      ),
      child: Padding(
        ...
        child: ElevatedButton(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            icon != null ? Padding(
              ...
              child: Icon(icon, color: transparent ? Get.isDarkMode ? Theme.of(context).primaryColorDark : Theme.of(context).primaryColor : Theme.of(context).cardColor),
            ) : SizedBox(),
            Text(buttonText ??'', textAlign: TextAlign.center, style: robotoBold.copyWith(
               //color: transparent  ? Get.isDarkMode ?  Theme.of(context).primaryColor : Theme.of(context).primaryColor : Theme.of(context).cardColor,
                 color: transparent ? Theme.of(context).hintColor : Get.isDarkMode ?  Theme.of(context).primaryColor : Theme.of(context).cardColor,
