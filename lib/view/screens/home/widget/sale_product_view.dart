...
class SaleProductView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ProductController>(builder: (productController) {
      int pLength = productController.saleProductList != null
          ? productController.saleProductList.length > 3
              ? 3
              : productController.saleProductList.length
          : 0;

      return productController.saleProductList == null
          ? SaleProductShimmer(productController: productController)
          : (productController.saleProductList.length != null &&
                  productController.saleProductList.length == 0)
              ? SizedBox()
              :
              ...
              Column(
                  children: [
                            ...
                            InkWell(
                              onTap: () {
                                Get.to(() => AllProductScreen(
                                    productType: ProductType.SALE_PRODUCT));
                              },
                              child: Text(
                                "See All",
                    ...
                    ListView.builder(
                      ...
                      physics: BouncingScrollPhysics(),
                      padding: EdgeInsets.zero,
                      itemCount: productController.saleProductList.length > 3
                          ? 3
                          : productController.saleProductList.length,
                      itemBuilder: (context, index) {
                        return Padding(
                            ...
                            onTap: () {
                              Get.toNamed(
                                RouteHelper.getProductDetailsRoute(
                                    productController.saleProductList[index].id,
                                    '',
                                    false),
                                arguments: ProductDetailsScreen(
                                  product:
                                      productController.saleProductList[index],
                                  url: '',
                                ),
                              );
                            },
                                          ...
                                          child: CircleAvatar(
                                            ...
                                            child:
                                              ...
                                              return InkWell(
                                                  child: Center(
                                                      child: Icon(
                                                          wishController.wishIdList.contains(
                                                                  productController
                                                                      .saleProductList[
                                                                          index]
                                                                      .id)
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            PriceConverter.convertPrice(
                                              ...
                                              taxStatus: productController
                                                  .saleProductList[index]
                                                  .taxStatus,
                                              taxClass: productController
                                                  .saleProductList[index]
                                                  .taxClass,
                                            ),
                                            style: poppinsMedium.copyWith(
